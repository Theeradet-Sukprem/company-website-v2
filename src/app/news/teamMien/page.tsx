...
export default function page() {
    ...
    return (
        <div className='bg-white'>
            ...
            <div className="container mx-auto px-4 py-35 max-w-7xl ">
                {/* Header Section */}
                <div className="mb-8">
                ...
                {/* Grid Layout */}
                <div className={`grid gap-6 mb-8 ${windowWidth >= 1024
                    ...
                    {currentItems.map((activity) => (
                        ...
                        >
                            ...
                            <div className="p-4 flex flex-col h-full">
                                ...
                                <span className="mt-auto text-xs text-gray-500 uppercase tracking-wide">{activity.subtitle}</span>
                            </div>
                        </div>
                    ))}
                </div>
